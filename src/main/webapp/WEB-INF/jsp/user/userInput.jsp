                            ...
                            <div class="control-group">
                                ...
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" name="genderValue" <c:if test="${userForm.genderValue == '1'}">checked="checked"</c:if> value="1"> 男
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="genderValue" <c:if test="${userForm.genderValue == '2'}">checked="checked"</c:if> value="2"> 女
                                    </label>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" name="validValue" <c:if test="${userForm.validValue == '1'}">checked="checked"</c:if> value="1"> 是
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="validValue" <c:if test="${userForm.validValue == '2'}">checked="checked"</c:if> value="2"> 否
                                    </label>
                                </div>
                            </div>
                            <div class="">
